...
<div class="container content-invoice">
    	<div class="cards">
	    	...
	    	<div class="load-animate animated fadeInUp">
		    	<div class="row">
		    		<div class="col-xs-12">
		    			<h1 class="title">SMR Invoice System</h1>
		    	...
		    	<div class="row">
		      		...
		      		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
						...
						<div class="form-group">
							<!-- <textarea type="file" class="form-control" name="aadhaar" id="aadhaar" placeholder="Aadhaar"><?php echo
							 $invoiceValues['order_receiver_aadhaar']; ?></textarea> -->
							 <input type="file" class="form-control" name="aadhaar" id="aadhaar" placeholder="Aadhaar"><?php echo
							 $invoiceValues['order_receiver_aadhaar']; ?>>
						</div>
						<div class="form-group">
							<textarea class="form-control" name="mobile" id="mobile" placeholder="Mobile Number"><?php echo
							 $invoiceValues['order_receiver_mobile']; ?></textarea>
						</div>
		      		...
		      		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		      			<table class="table table-condensed table-striped" id="invoiceItem">	
							<tr>
								...
								<th width="15%">Fault/Description</th>
