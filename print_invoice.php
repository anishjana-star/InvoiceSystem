...
$output .= '<table width="100%" border="1" cellpadding="5" cellspacing="0">
	...
	Mobile Number : '.$invoiceValues['order_receiver_mobile'].'<br />
	Aadhaar : '.$invoiceValues['order_receiver_aadhaar'].'<br />
	...
	<th align="left">Fault/Description</th>
...
$output .= '
	<tr>
	<td align="right" colspan="5">Tax Rate:</td>
...
$invoiceFileName = 'SMR_Invoice_'.$invoiceValues['order_id'].'.pdf';
