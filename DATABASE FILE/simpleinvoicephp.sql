...
CREATE TABLE `invoice_order` (
  ...
  `order_receiver_aadhaar` varchar(255) NOT NULL,
  `order_receiver_mobile` varchar(255) NOT NULL,
...
INSERT INTO `invoice_order` (`user_id`, `order_id`, `order_receiver_name`, `order_receiver_address`, `order_receiver_aadhaar`, `order_receiver_mobile`, `order_total_before_tax`, `order_total_tax`, `order_tax_per`, `order_total_after_tax`, `order_amount_paid`, `order_total_amount_due`, `order_date`, `note`) VALUES
(1, 3, 'Demo Company', '225 Demo Address', '1234 5678', '1234567890', '198', '0', '0', '198', '198', '0', '2021-07-11 23:30:54', 'demo trial'),
(1, 4, 'Atsupplies', '323 Posum Point Road', '5678 4357', '0987654321', '2036', '142.52', '7', '2178.52', '2178.52', '0', '2021-07-12 00:01:07', 'None, demo test!!!'),
(1, 5, 'Assestit Company', '247 Clan Alpine Way', '0987 6545', '5678904321', '4116', '288.12', '7', '4404.12', '4404.12', '0', '2021-07-12 00:06:31', 'none at the moment!!');
